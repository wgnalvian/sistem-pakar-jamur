...
@endif
    ...
    <div class="row tw-px-10 tw-box-border">
        <div class="col-12 tw-px-4 mt-7 tw-box-border">
            <h6 class="font-weight-bolder tw-text-4xl  text-white mb-0">Pilih Kondisi</h6>
        </div>
    </div>

    <form action="/alternative/isharvest" method="post">
        @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($conditions as $condition)
                                <tr class=" tw-border-b">
                                    ...
                                    <td class="tw-text-sm tw-box-border tw-border-r tw-px-3">{{ $condition->name }}</td>
